...
public class OrderCircuitController {
    ...
    // myCircuitFallBack()方法就时服务降级后的兜底方法
    public String myCircuitFallBack(@PathVariable("id") Integer id, Throwable e) {
        // 容错处理处理逻辑，返回备用结果
    ...
    /**
     * Resilience4j 限流 RateLimiter 实例
     */
    ...
    public String myRateLimiterFallback(Integer id,Throwable e) {
